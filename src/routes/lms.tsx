...
export const Route = createFileRoute("/lms")({
  head: () => ({
    meta: [
      { title: "Learning Management | Vidya ERP" },
      { name: "description", content: "Digital courses, video lessons, notes and quizzes for blended learning." },
      { property: "og:title", content: "Learning Management — Vidya ERP" },
      { property: "og:description", content: "Digital courses, video lessons, notes and quizzes for blended learning." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="💻"
        title={bi("अनलाइन कक्षा", "Learning Management")}
        subtitle="Digital courses, video lessons, notes and quizzes for blended learning."

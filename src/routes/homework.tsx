...
export const Route = createFileRoute("/homework")({
  head: () => ({
    meta: [
      { title: "Homework | Vidya ERP" },
      { name: "description", content: "Assign, submit and review daily homework across classes and subjects." },
      { property: "og:title", content: "Homework — Vidya ERP" },
      { property: "og:description", content: "Assign, submit and review daily homework across classes and subjects." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="📒"
        title={bi("गृहकार्य", "Homework")}
        subtitle="Assign, submit and review daily homework across classes and subjects."

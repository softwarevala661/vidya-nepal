...
export const Route = createFileRoute("/communication")({
  head: () => ({
    meta: [
      { title: "Communication | Vidya ERP" },
      { name: "description", content: "Notices, SMS, email campaigns and parent messaging." },
      { property: "og:title", content: "Communication — Vidya ERP" },
      { property: "og:description", content: "Notices, SMS, email campaigns and parent messaging." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="📣"
        title={bi("सञ्चार", "Communication")}
        subtitle="Notices, SMS, email campaigns and parent messaging."

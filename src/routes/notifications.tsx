...
export const Route = createFileRoute("/notifications")({
  head: () => ({
    meta: [
      { title: "Notifications | Vidya ERP" },
      { name: "description", content: "All system alerts, approvals and reminders in one place." },
      { property: "og:title", content: "Notifications — Vidya ERP" },
      { property: "og:description", content: "All system alerts, approvals and reminders in one place." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="🔔"
        title={bi("सूचना", "Notifications")}
        subtitle="All system alerts, approvals and reminders in one place."

...
export const Route = createFileRoute("/teacher-portal")({
  head: () => ({
    meta: [
      { title: "Teacher Portal | Vidya ERP" },
      { name: "description", content: "My classes, attendance marking, homework and grading workspace." },
      { property: "og:title", content: "Teacher Portal — Vidya ERP" },
      { property: "og:description", content: "My classes, attendance marking, homework and grading workspace." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="👩‍🏫"
        title={bi("शिक्षक पोर्टल", "Teacher Portal")}
        subtitle="My classes, attendance marking, homework and grading workspace."

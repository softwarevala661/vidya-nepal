...
export const Route = createFileRoute("/results")({
  head: () => ({
    meta: [
      { title: "Results & Marksheets | Vidya ERP" },
      { name: "description", content: "GPA-based marksheets, grade sheets and printable report cards for every student." },
      { property: "og:title", content: "Results & Marksheets — Vidya ERP" },
      { property: "og:description", content: "GPA-based marksheets, grade sheets and printable report cards for every student." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="🏆"
        title={bi("नतिजा", "Results & Marksheets")}
        subtitle="GPA-based marksheets, grade sheets and printable report cards for every student."

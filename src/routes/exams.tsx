...
export const Route = createFileRoute("/exams")({
  head: () => ({
    meta: [
      { title: "Examinations | Vidya ERP" },
      { name: "description", content: "Exam schedule, admit cards, seat plans and invigilation duty for terminal and final exams." },
      { property: "og:title", content: "Examinations — Vidya ERP" },
      { property: "og:description", content: "Exam schedule, admit cards, seat plans and invigilation duty for terminal and final exams." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="📝"
        title={bi("परीक्षा", "Examinations")}
        subtitle="Exam schedule, admit cards, seat plans and invigilation duty for terminal and final exams."

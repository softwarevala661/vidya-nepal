...
export const Route = createFileRoute("/transport")({
  head: () => ({
    meta: [
      { title: "Transport | Vidya ERP" },
      { name: "description", content: "School bus routes, stoppages, drivers and student pickup allocation." },
      { property: "og:title", content: "Transport — Vidya ERP" },
      { property: "og:description", content: "School bus routes, stoppages, drivers and student pickup allocation." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        ...
        subtitle="School bus routes, stoppages, drivers and student pickup allocation."

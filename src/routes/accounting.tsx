...
export const Route = createFileRoute("/accounting")({
  head: () => ({
    meta: [
      { title: "Accounting | Vidya ERP" },
      { name: "description", content: "Income, expenses, ledgers and financial statements for the school." },
      { property: "og:title", content: "Accounting — Vidya ERP" },
      { property: "og:description", content: "Income, expenses, ledgers and financial statements for the school." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="📊"
        title={bi("लेखा", "Accounting")}
        subtitle="Income, expenses, ledgers and financial statements for the school."

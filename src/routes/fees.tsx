...
export const Route = createFileRoute("/fees")({
  head: () => ({
    meta: [
      { title: "Fees & Billing | Vidya ERP" },
      { name: "description", content: "Fee structures, invoices, receipts, dues and collection summary in Nepali rupees." },
      { property: "og:title", content: "Fees & Billing — Vidya ERP" },
      { property: "og:description", content: "Fee structures, invoices, receipts, dues and collection summary in Nepali rupees." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="💰"
        title={bi("शुल्क", "Fees & Billing")}
        subtitle="Fee structures, invoices, receipts, dues and collection summary in Nepali rupees."

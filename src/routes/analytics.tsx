...
export const Route = createFileRoute("/analytics")({
  head: () => ({
    meta: [
      { title: "Analytics | Vidya ERP" },
      { name: "description", content: "Performance, attendance and finance analytics across the school." },
      { property: "og:title", content: "Analytics — Vidya ERP" },
      { property: "og:description", content: "Performance, attendance and finance analytics across the school." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        ...
        subtitle="Performance, attendance and finance analytics across the school."

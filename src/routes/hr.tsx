...
export const Route = createFileRoute("/hr")({
  head: () => ({
    meta: [
      { title: "HR & Payroll | Vidya ERP" },
      { name: "description", content: "Staff records, leave, payroll and provident fund summary." },
      { property: "og:title", content: "HR & Payroll — Vidya ERP" },
      { property: "og:description", content: "Staff records, leave, payroll and provident fund summary." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="🧑‍💼"
        title={bi("मानव संसाधन", "HR & Payroll")}
        subtitle="Staff records, leave, payroll and provident fund summary."

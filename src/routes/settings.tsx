...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      { title: "Settings | Vidya ERP" },
      { name: "description", content: "School profile, grading scheme, roles, permissions and preferences." },
      { property: "og:title", content: "Settings — Vidya ERP" },
      { property: "og:description", content: "School profile, grading scheme, roles, permissions and preferences." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="⚙️"
        title={bi("सेटिङ", "Settings")}
        subtitle="School profile, grading scheme, roles, permissions and preferences."

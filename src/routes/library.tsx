...
export const Route = createFileRoute("/library")({
  head: () => ({
    meta: [
      { title: "Library | Vidya ERP" },
      { name: "description", content: "Book catalogue, issue and return register, fines and reading trends." },
      { property: "og:title", content: "Library — Vidya ERP" },
      { property: "og:description", content: "Book catalogue, issue and return register, fines and reading trends." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        ...
        subtitle="Book catalogue, issue and return register, fines and reading trends."

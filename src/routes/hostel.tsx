...
export const Route = createFileRoute("/hostel")({
  head: () => ({
    meta: [
      { title: "Hostel | Vidya ERP" },
      { name: "description", content: "Room allocation, warden roster, mess menu and hostel attendance." },
      { property: "og:title", content: "Hostel — Vidya ERP" },
      { property: "og:description", content: "Room allocation, warden roster, mess menu and hostel attendance." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        ...
        subtitle="Room allocation, warden roster, mess menu and hostel attendance."

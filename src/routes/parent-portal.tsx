...
export const Route = createFileRoute("/parent-portal")({
  head: () => ({
    meta: [
      { title: "Parent Portal | Vidya ERP" },
      { name: "description", content: "Child progress, attendance, fees and teacher communication for parents." },
      { property: "og:title", content: "Parent Portal — Vidya ERP" },
      { property: "og:description", content: "Child progress, attendance, fees and teacher communication for parents." },
    ],
  }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader
        emoji="👨‍👩‍👦"
        title={bi("अभिभावक पोर्टल", "Parent Portal")}
        subtitle="Child progress, attendance, fees and teacher communication for parents."
